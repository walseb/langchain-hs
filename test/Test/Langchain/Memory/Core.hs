...
module Test.Langchain.Memory.Core where
...
-- Tests for WindowBufferMemory
windowBufferMemoryTests :: TestTree
windowBufferMemoryTests = testGroup "WindowBufferMemory Tests"
...
-- Tests for Runnable instance
runnableTests :: TestTree
runnableTests = testGroup "Runnable Instance Tests"
...
-- Main test group
tests :: TestTree
tests = testGroup "Langchain.Memory.Core Tests"
  [ utilityTests
